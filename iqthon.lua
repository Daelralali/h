...
local iqthon = io.open("iqthon", 'w')
iqthon:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 iqthon.lua
done
]])
iqthon:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S iqthon -X kill
screen -S iqthon ./iqthon
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x iqthon;chmod +x Run;./Run')
end
...
iqthon = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..iqthon)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=iqthon,token=Token}
LUATELE = URL.escape(""..iqthon.."\n"..UserBot.."\n"..UserSudo.."\n"..Token.."")
...
ControllerAll = false
local ListSudos ={Sudo_Id,1226408155}  
...
Status = 0
DevelopersQ = Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(iqthon.."iqthon:Developers:Groups",UserId) 
TheBasics = Redis:sismember(iqthon.."iqthon:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(iqthon.."iqthon:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(iqthon.."iqthon:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(iqthon.."iqthon:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(iqthon.."iqthon:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(iqthon.."iqthon:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1226408155 then
Status  = 'مبرمج السورس'
elseif UserId == 203019 then
Status = 'مطور سورس'
elseif UserId == 3020176 then
Status = 'مطور سورس'
elseif UserId == 302019 then
Status = 'مطوره سورس'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == iqthon then
Status = 'البوت'
elseif Developers then
Status = Redis:get(iqthon.."iqthon:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(iqthon.."iqthon:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(iqthon.."iqthon:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(iqthon.."iqthon:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(iqthon.."iqthon:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(iqthon.."iqthon:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(iqthon.."iqthon:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(iqthon.."iqthon:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(iqthon.."iqthon:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(iqthon.."iqthon:lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(iqthon.."iqthon:Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(iqthon.."iqthon:Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(iqthon.."iqthon:Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(iqthon.."iqthon:Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(iqthon.."iqthon:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(iqthon.."iqthon:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(iqthon.."iqthon:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(iqthon.."iqthon:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(iqthon.."iqthon:Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(iqthon.."iqthon:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(iqthon.."iqthon:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(iqthon.."iqthon:Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(iqthon.."iqthon:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(iqthon.."iqthon:Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(iqthon.."iqthon:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(iqthon.."iqthon:Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(iqthon.."iqthon:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(iqthon.."iqthon:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(iqthon.."iqthon:Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(iqthon.."iqthon:Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(iqthon.."iqthon:Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(iqthon.."iqthon:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(iqthon.."iqthon:Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(iqthon.."iqthon:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(iqthon.."iqthon:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(iqthon.."iqthon:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
JabwaAll = Redis:sismember(iqthon.."iqthon:JabwaAll:Groups",UserId) ,
ktmall = Redis:sismember(iqthon.."iqthon:ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(iqthon.."iqthon:JabwaGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(iqthon.."iqthon:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,iqthon).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(iqthon.."chfalse")
if chh then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(iqthon.."Lock:channell"..msg_chat_id) then
print(Redis:get(iqthon.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(iqthon.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(iqthon..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(iqthon) then
...
if tonumber(msg.sender.user_id) == 1226408155 then
msg.Name_Controller = 'مبرمج السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 203019 then
msg.Name_Controller = 'مطور السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 3020176 then
msg.Name_Controller = 'مطور السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 302019 then
msg.Name_Controller = 'مطوره السورس'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(iqthon.."iqthon:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(iqthon.."iqthon:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(iqthon.."iqthon:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(iqthon.."iqthon:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(iqthon.."iqthon:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(iqthon.."iqthon:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(iqthon.."iqthon:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(iqthon.."iqthon:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(iqthon.."iqthon:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(iqthon.."iqthon:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(iqthon.."iqthon:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(iqthon) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(iqthon.."iqthon:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(iqthon.."iqthon:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(iqthon.."iqthon:Status:Welcome"..msg_chat_id) then
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(iqthon.."iqthon:Welcome:Group"..msg_chat_id)
if Welcome then 
if Jabwa.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(iqthon.."iqthon:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(iqthon) then
return false
end
local floods = Redis:hget(iqthon.."iqthon:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_iqthon = Redis:hget(iqthon.."iqthon:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(iqthon.."iqthon:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(iqthon.."iqthon:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(iqthon.."iqthon:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(iqthon.."iqthon:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(iqthon.."iqthon:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_iqthon = 5
if Redis:hget(iqthon.."iqthon:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_iqthon = Redis:hget(iqthon.."iqthon:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(iqthon.."iqthon:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(iqthon.."iqthon:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(iqthon.."iqthon:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'Jabwaned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(iqthon.."iqthon:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(iqthon.."iqthon:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(iqthon.."iqthon:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(iqthon.."iqthon:Lock:Keyboard"..msg_chat_id)
...
if msg.content.location and not msg.Manager then  -- الموقع
if location then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
local Markduan_Gtoup = Redis:get(iqthon.."iqthon:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(iqthon.."iqthon:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(iqthon.."iqthon:lockpin"..msg_chat_id)
...
Redis:incr(iqthon.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(iqthon.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(iqthon.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(iqthon) then
local N = (Redis:get(iqthon.."iqthon:Name:Bot") or "تليثون")
photo = LuaTele.getUserProfilePhotos(iqthon)
...
Redis:set(iqthon.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(iqthon.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(iqthon.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(iqthon.."iqthon:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(iqthon.."iqthon:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(iqthon.."iqthon:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(iqthon.."iqthon:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(iqthon.."iqthon:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(iqthon.."iqthon:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(iqthon.."iqthon:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(iqthon.."iqthon:Lock:Animation"..msg_chat_id)
...
if text and Redis:get(iqthon..'lock:Fshar'..msg.chat_id) and not msg.DevelopersQ then 
...
if text and Redis:get(iqthon..'lock:Fars'..msg.chat_id) and not msg.DevelopersQ then 
...
if text and Redis:get(iqthon..'lock:Cht'..msg.chat_id) and not msg.DevelopersQ then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
local Photo_Group = Redis:get(iqthon.."iqthon:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(iqthon.."iqthon:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(iqthon.."iqthon:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(iqthon.."iqthon:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(iqthon.."iqthon:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(iqthon.."iqthon:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(iqthon.."iqthon:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(iqthon..'iqthon:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(iqthon.."iqthon:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(iqthon.."iqthon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(iqthon.."iqthon:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(iqthon.."iqthon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(iqthon.."iqthon:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(iqthon.."iqthon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(iqthon.."iqthon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(iqthon.."iqthon:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(iqthon..'iqthon:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n*♛ ︙  ارسل تحذير〘 "..Filters.." 〙عند ارساله*","md",true)  
end
end
if text and (Redis:get(iqthon..'iqthon:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(iqthon.."iqthon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(iqthon.."iqthon:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(iqthon.."iqthon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(iqthon..'iqthon:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n*♛ ︙  تم اضافه رد التحذير*","md",true)  
end
if text and (Redis:get(iqthon..'iqthon:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(iqthon.."iqthon:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(iqthon.."iqthon:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(iqthon.."iqthon:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(iqthon.."iqthon:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(iqthon.."iqthon:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(iqthon.."iqthon:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(iqthon.."iqthon:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(iqthon.."iqthon:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(iqthon..'iqthon:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(iqthon.."iqthon:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(iqthon.."iqthon:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(iqthon.."iqthon:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(iqthon.."iqthon:All:Get:Reides:Commands:Group"..text)
Redis:del(iqthon.."iqthon:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(iqthon.."iqthon:All:Command:List:Group",text)
...
Redis:del(iqthon.."iqthon:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(iqthon.."iqthon:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(iqthon.."iqthon:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(iqthon.."iqthon:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(iqthon.."iqthon:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(iqthon.."iqthon:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(iqthon.."iqthon:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(iqthon.."iqthon:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(iqthon.."iqthon:All:Command:List:Group",text)
Redis:del(iqthon.."iqthon:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  تم حفظ الامر باسم ⇦〘 "..text..' 〙*',"md",true)
end

if text and Redis:get(iqthon.."iqthon:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(iqthon.."iqthon:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(iqthon.."iqthon:Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  تم ازالة هاذا ⇦〘 "..text.." 〙*","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  لا يوجد امر بهاذا الاسم*","md",true)
end
Redis:del(iqthon.."iqthon:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(iqthon.."iqthon:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(iqthon.."iqthon:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(iqthon.."iqthon:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(iqthon.."iqthon:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(iqthon.."iqthon:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(iqthon.."iqthon:Command:Reids:Group:New"..msg_chat_id)
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(iqthon.."iqthon:Command:List:Group"..msg_chat_id,text)
Redis:del(iqthon.."iqthon:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  تم حفظ الامر باسم ⇦〘 "..text..' 〙*',"md",true)
end
if Redis:get(iqthon.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(iqthon.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(iqthon.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(iqthon.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥♛ ︙ تم حفظ الرابط بنجاح","md",true)         
end
end 

if Redis:get(iqthon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(iqthon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(iqthon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(iqthon.."iqthon:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ ترحيب المجموعه","md",true)     
end

if Redis:get(iqthon.."iqthon:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(iqthon.."iqthon:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(iqthon.."iqthon:Group:Rules" .. msg_chat_id,text) 
Redis:del(iqthon.."iqthon:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  تم حفظ قوانين المجموعه*","md",true)  
end  
if Redis:get(iqthon.."iqthon:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(iqthon.."iqthon:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(iqthon.."iqthon:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(iqthon.."iqthon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(iqthon.."iqthon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(iqthon.."iqthon:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(iqthon.."iqthon:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(iqthon.."iqthon:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(iqthon.."iqthon:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(iqthon.."iqthon:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(iqthon.."iqthon:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(iqthon.."iqthon:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(iqthon.."iqthon:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
print(idPhoto)
Redis:set(iqthon.."iqthon:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"♛ ︙  تم حفظ رد للمدير بنجاح \n♛ ︙  ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(iqthon.."iqthon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(iqthon.."iqthon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(iqthon.."iqthon:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(iqthon.."iqthon:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(iqthon.."iqthon:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(iqthon.."iqthon:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(iqthon.."iqthon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(iqthon.."iqthon:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(iqthon.."iqthon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(iqthon.."iqthon:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"♛ ︙  تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(iqthon.."iqthon:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(iqthon.."iqthon:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(iqthon.."iqthon:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Video"..text)
local document = Redis:get(iqthon.."iqthon:Add:Rd:Sudo:File"..text)
local audio = Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(iqthon.."iqthon:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(iqthon..'iqthon:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(iqthon..'iqthon:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(iqthon.."iqthon:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(iqthon.."iqthon:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(iqthon.."iqthon:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(iqthon.."iqthon:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(iqthon.."iqthon:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(iqthon.."iqthon:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(iqthon.."iqthon:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(iqthon.."iqthon:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(iqthon.."iqthon:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(iqthon.."iqthon:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(iqthon..'iqthon:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(iqthon.."iqthon:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(iqthon.."iqthon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(iqthon.."iqthon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(iqthon.."iqthon:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(iqthon.."iqthon:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(iqthon.."iqthon:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(iqthon.."iqthon:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(iqthon.."iqthon:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(iqthon.."iqthon:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(iqthon.."iqthon:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(iqthon.."iqthon:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(iqthon.."iqthon:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(iqthon.."iqthon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(iqthon.."iqthon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(iqthon.."iqthon:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(iqthon.."iqthon:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯♛ ︙ ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(iqthon.."iqthon:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(iqthon..'iqthon:'..v..text)
end
Redis:del(iqthon.."iqthon:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(iqthon.."iqthon:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"♛ ︙  تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(iqthon.."iqthon:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(iqthon.."iqthon:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*♛ ︙  تم الغاء الاذاعه بالتثبيت*","md",true)  
end 
local list = Redis:smembers(iqthon.."iqthon:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(iqthon.."iqthon:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(iqthon.."iqthon:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(iqthon.."iqthon:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(iqthon.."iqthon:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(iqthon.."iqthon:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(iqthon.."iqthon:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(iqthon.."iqthon:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(iqthon.."iqthon:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(iqthon.."iqthon:PinMsegees:"..v,text)
end
end
...
if Redis:get(iqthon.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(iqthon.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*♛ ︙  تم الغاء الاذاعه بالتوجيه للخاص*","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(iqthon.."iqthon:Num:User:Pv") 
...
if Redis:get(iqthon.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(iqthon.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(iqthon.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(iqthon.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(iqthon.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(iqthon.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(iqthon..'iqthon:GetTexting:Deviqthon'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '〘 الغاء الامر 〙' then 
Redis:del(iqthon..'iqthon:GetTexting:Deviqthon'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ↯♛ ︙  تم الغاء حفظ كليشة المطور')
end
Redis:set(iqthon..'iqthon:Texting:Deviqthon',text)
Redis:del(iqthon..'iqthon:GetTexting:Deviqthon'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ↯♛ ︙  تم حفظ كليشة المطور')
end
if Redis:get(iqthon.."iqthon:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n♛ ︙  تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(iqthon.."iqthon:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(iqthon.."iqthon:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(iqthon.."iqthon:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ↯♛ ︙  تم تعين الايدي عام',"md",true)  
end
if Redis:get(iqthon.."iqthon:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n♛ ︙  تم الغاء امر تعين الايدي","md",true)  
Redis:del(iqthon.."iqthon:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(iqthon.."iqthon:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(iqthon.."iqthon:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ↯♛ ︙  تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(iqthon.."iqthon:Change:iqthon:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(iqthon.."iqthon:Change:iqthon:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n♛ ︙  تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(iqthon.."iqthon:Change:iqthon:Name:Bot"..msg.sender.user_id) 
Redis:set(iqthon.."iqthon:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ♛ ︙  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(iqthon.."iqthon:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(iqthon.."iqthon:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n♛ ︙  تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(iqthon.."iqthon:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(iqthon.."iqthon:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ♛ ︙  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(iqthon.."iqthon:Game:Smile"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:Smile"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n♛ ︙  لقد فزت في اللعبه \n♛ ︙  اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(iqthon.."iqthon:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:Monotonous"..msg.chat_id) then
Redis:del(iqthon.."iqthon:Game:Monotonous"..msg.chat_id)
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n♛ ︙  لقد فزت في اللعبه \n♛ ︙  اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(iqthon.."iqthon:Game:Alam"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:Alam"..msg.chat_id) then
Redis:del(iqthon.."iqthon:Game:Alam"..msg.chat_id)
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n♛ ︙  لقد فزت في اللعبه \n♛ ︙  اللعب مره اخره وارسل - اعلام او الاعلام","md",true)  
end
end 
if Redis:get(iqthon.."iqthon:Game:Riddles"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:Riddles"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n♛ ︙  لقد فزت في اللعبه \n♛ ︙  اللعب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(iqthon.."iqthon:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:Meaningof"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n♛ ︙  لقد فزت في اللعبه \n♛ ︙  اللعب مره اخره وارسل - معاني","md",true)  
end
end
if Redis:get(iqthon.."iqthon:Game:Reflection"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:Reflection"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n♛ ︙  لقد فزت في اللعبه \n♛ ︙  اللعب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(iqthon.."iqthon:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(iqthon.."iqthon:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(iqthon.."iqthon:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(iqthon.."iqthon:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸♛ ︙ تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(iqthon.."iqthon:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(iqthon.."iqthon:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(iqthon.."iqthon:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(iqthon.."iqthon:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if text then
local NewCmmd = Redis:get(iqthon.."iqthon:All:Get:Reides:Commands:Group"..text) or Redis:get(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(iqthon.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(iqthon.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(iqthon.."chfalse")
Redis:set(iqthon.."chfalse",ch)
Redis:del(iqthon.."ch:admin")
Redis:set(iqthon.."ch:admin",data.result.invite_link)
else
...
Redis:set(iqthon.."ch:addd"..msg.sender.user_id,"on")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = Redis:get(iqthon..'ch:admin')},},{{text = 'سـورس تليثون ', url = 't.me/iqthon'},},}}
...
if tonumber(iqthon) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,' ↯♛ ︙  عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(iqthon..'iqthon:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(iqthon.."iqthon:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(iqthon.."iqthon:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(iqthon.."iqthon:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(iqthon.."iqthon:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(iqthon.."iqthon:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(iqthon.."iqthon:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(iqthon) then 
return LuaTele.sendText(msg_chat_id,msg_id,' ↯♛ ︙  عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(iqthon.."iqthon:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(iqthon.."iqthon:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(iqthon.."iqthon:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(iqthon.."iqthon:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(iqthon.."iqthon:TheBasics:Group"..idg,idASAS)
end;end
end
...
--os.execute('rm -rf iqthon.lua')
--download('https://raw.githubusercontent.com/telethonAr/A/blob/main/iqthon.lua')
...
Redis:del(iqthon.."iqthon:SendBcBot") 
...
Redis:set(iqthon.."iqthon:SendBcBot",true) 
...
Redis:del(iqthon.."iqthon:LeftBot") 
...
Redis:set(iqthon.."iqthon:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(iqthon.."iqthon:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(iqthon.."iqthon:AddSudosNew"..msg_chat_id)
...
Redis:set(iqthon.."iqthon:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(iqthon..'iqthon:ChekBotAdd')  
local UsersBot = Redis:smembers(iqthon..'iqthon:Num:User:Pv')  
local Get_Json = '{"BotId": '..iqthon..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(iqthon.."iqthon:TheBasics:Group"..v)
local Constructor = Redis:smembers(iqthon.."iqthon:Originators:Group"..v)
local Manager = Redis:smembers(iqthon.."iqthon:Managers:Group"..v)
local Admin = Redis:smembers(iqthon.."iqthon:Addictive:Group"..v)
local Vips = Redis:smembers(iqthon.."iqthon:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(iqthon..'iqthon:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(iqthon)
local UserInfo = LuaTele.getUser(iqthon)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NameBot = (Redis:get(iqthon.."iqthon:Name:Bot") or "تليثون")
Groups = (Redis:scard(iqthon..'iqthon:ChekBotAdd') or 0)
Users = (Redis:scard(iqthon..'iqthon:Num:User:Pv') or 0)
if photo.total_count > 0 then
local Jabwa = 'اسم بوت -› '..NameBot..''
local Grosupsw = 'المجموعات -› '..Groups..''
local Usperos = 'المشتركين -› '..Users..''
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = Jabwa, url = 't.me/iqthon'}, 
},
{
{text = Grosupsw, url = 't.me/iqthon'}, 
},
{
{text = Usperos, url = 't.me/iqthon'}, 
},
}
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(NameBot).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
if Redis:sismember(iqthon.."iqthon:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(iqthon..'iqthon:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'♛ ︙  عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(iqthon..'iqthon:Num:Add:Bot'),"md",true)  
end
...
{
{text = 'اوامر الحمايه ', data =msg.sender.user_id..'/listallAddorr@'..msg_chat_id},
},
}
}
if not msg.ControllerBot then
...
Redis:sadd(iqthon.."iqthon:ChekBotAdd",msg_chat_id)
Redis:set(iqthon.."iqthon:Status:Id"..msg_chat_id,true) ;Redis:set(iqthon.."iqthon:Status:Reply"..msg_chat_id,true) ;Redis:set(iqthon.."iqthon:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(iqthon.."iqthon:Status:BanId"..msg_chat_id,true) ;Redis:set(iqthon.."iqthon:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(iqthon.."iqthon:BotFree") then
...
Redis:sadd(iqthon.."iqthon:ChekBotAdd",msg_chat_id)
Redis:set(iqthon.."iqthon:Status:Id"..msg_chat_id,true) ;Redis:set(iqthon.."iqthon:Status:Reply"..msg_chat_id,true) ;Redis:set(iqthon.."iqthon:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(iqthon.."iqthon:Status:JabwaId"..msg_chat_id,true) ;Redis:set(iqthon.."iqthon:Status:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*♛ ︙  اسم المجموعه -›〘*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*〙\n♛ ︙  تم تفعيل المجموعه *','md', true, false, false, false, reply_markup)
end
end
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(iqthon.."iqthon:ChekBotAdd",msg_chat_id) then
...
Redis:srem(iqthon.."iqthon:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(iqthon.."iqthon:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if not Redis:get(iqthon.."iqthon:Status:Id"..msg_chat_id) then
return false
end
local Jabwa = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(iqthon..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(iqthon..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(iqthon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(iqthon.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {"〈  صورتك يا قمر 😻🤍 〉 ","〈  العسل  🥺💔 〉","〈 صورتك لوصوره القمر 🌙💕 〉","〈 صورتك عثل ينوحيي 🙈🌝 〉",}
local Description = Texting[math.random(#Texting)]
local date = os.date("%Y/%m/%d") 
local time = os.date("*t")
local hour = time.hour
local min = time.min
local timee = os.date("%I:%M")
if Jabwa.username then
Jabwausername = '@'..Jabwa.username..''
else
Jabwausername = 'لا يوجد'
...
Get_Is_Id = Redis:get(iqthon.."iqthon:Set:Id:Groups") or Redis:get(iqthon.."Set:Id:Group"..msg_chat_id)
if Redis:get(iqthon.."iqthon:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local Get_Is_Id = Get_Is_Id:gsub('#date',date) 
local Get_Is_Id = Get_Is_Id:gsub('#time',timee) 
if photo.total_count > 0 then
...
local TotalMsg = Redis:get(iqthon..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(iqthon..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(iqthon.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(iqthon.."Num:Add:Games"..msg.chat_id..UserId) or 0
local date = os.date("%Y/%m/%d")  
local timee = os.date("%I:%M")
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local texting = {'لوكي وزاحف من ساع زحفلي وحضرته 😒','خوش ولد و ورده مال الله 🙄','يلعب ع البنات 🙄', 'ولد زايعته الكاع 😶🙊','صاك يخبل ومعضل ','محلو وشواربه جنها مكناسه 😂🤷🏼‍♀️','اموت عليه 🌝','هوه غير الحب مال اني ❤️','مو خوش ولد صراحه ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' }
return LuaTele.sendText(msg.chat_id, msg.id, ''..texting[math.random(#texting)]..'')
end
if text == "نسبه حب" or text == "شكد الحب" or text == "نسبه الحب" then
local texting = {"7%","100%"," 80%","70%","0%","50%","10%","99%","000 حب زربا"}
return LuaTele.sendText(msg.chat_id, msg.id, ''..texting[math.random(#texting)]..'')
end
if text == "نسبه الرجوله" or text == "رجال لو مره" or text == "نسبه المثليه" or text == "نسبه الأنوثه" or text == "نسبه الانوثه" then
...
br = JSON.decode(gk)
return LuaTele.sendText(msg.chat_id, msg.id, br.ok.hso)
end
if text == "هينه" or text == "رزله" then
local texting = {"ملطلط","زاحفف معدل ","عاررر !! ","خوش ولد","اكبر ساقط  😂💔","يعني نص ونص 😂💔","كواد حبي "}
return LuaTele.sendText(msg.chat_id, msg.id, ''..texting[math.random(#texting)]..'')
end
if text == "مصه" or text == "بوسه" then
local texting = {"امووووووووواحح😘💕","مح مح مح مح","مووووووووحح 🙊 ","محححححححححح 💎💗😹"}
return LuaTele.sendText(msg.chat_id, msg.id, ''..texting[math.random(#texting)]..'')
end
if text == 'تنزيل جميع الرتب' then
                    if not msg.TheBasics then
                    return LuaTele.sendText(msg.chat_id, msg.id,'*♛ ︙ منشئ اساسي فقط لتكمز 😹😭 *') 
                    end
                    Redis:del(iqthon..'iqthon:Managers:Group'..msg.chat_id)
                    Redis:del(iqthon..'iqthon:Addictive:Group'..msg.chat_id)
                    Redis:del(iqthon..'iqthon:Distinguished:Group'..msg.chat_id)
                    Redis:del(iqthon..'iqthon:Vip:Group'..msg.chat_id)
                    Redis:del(iqthon..'iqthon:Constructor:Group'..msg.chat_id)
                    return LuaTele.sendText(msg.chat_id, msg.id, '♛ ︙ تم تنزيل جميع رتب الاعضاء من ▾\n♛ ︙ المنشئين ٬ المدراء ٬ الادمنيه ٬ المميزين \n')
                    end

if text == 'رابط الحذف' or text == 'روابط الحذف' then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = Redis:get(iqthon..'ch:admin')},},{{text = 'سـورس صعـب ', url = 't.me/MMUC2'},},}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
{
{text = '˛روابط الحذف .', url = 't.me/MMUC2'}, 
},
}
}
...
if not Redis:get(iqthon.."iqthon:Status:IdPhoto"..msg_chat_id) then
return false
end
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if text == "بايو" or text == "البايو" or text == "نبذتي" or text == "النبذه" or text == "نبذه" then
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(iqthon..'iqthon:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalEdit = Redis:get(iqthon..'iqthon:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
if Jabwa.username then
Jabwausername = '@'..Jabwa.username..''
else
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,iqthon).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,' ↯♛ ︙  البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,iqthon).status
if GetMemberStatus.can_change_info then
change_info = '【 ✅ 】' else change_info = '【 ❌ 】'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*♛ ︙  تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ♛ ︙  تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ♛ ︙  تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"*♛ ︙  تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(iqthon.."iqthon:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ♛ ︙  تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Developers:Groups",UserId) 
...
if not Redis:sismember(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(iqthon.."iqthon:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(iqthon.."iqthon:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(iqthon.."iqthon:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(iqthon.."iqthon:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(iqthon.."iqthon:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(iqthon.."iqthon:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(iqthon.."iqthon:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ♛ ︙  تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ♛ ︙  تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ♛ ︙  تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ♛ ︙  تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ♛ ︙  تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ♛ ︙  تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ♛ ︙  تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(iqthon.."iqthon:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ♛ ︙  تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Developers:Groups",UserId) 
...
if Redis:sismember(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(iqthon.."iqthon:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(iqthon.."iqthon:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ♛ ︙  تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(iqthon.."iqthon:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(iqthon.."iqthon:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(iqthon.."iqthon:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(iqthon.."iqthon:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(iqthon.."iqthon:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(iqthon.."iqthon:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(iqthon.."iqthon:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(iqthon.."iqthon:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(iqthon.."iqthon:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(iqthon.."iqthon:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(iqthon.."iqthon:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(iqthon.."iqthon:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(iqthon.."iqthon:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(iqthon.."iqthon:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(iqthon.."iqthon:JabwaAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(iqthon.."iqthon:ktmAll:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  لا يوجد مكتومين عام في البوت ","md",true)  
end
ListMembers = '\n*♛ ︙  قائمه المكتومين عام ⇧⇩*\n===سـورس تليثون مطورين السورس\n'
for k, v in pairs(Info_Members) do
local Jabwa = LuaTele.getUser(v)
if Jabwa and Jabwa.username and Jabwa.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..Jabwa.username.."](tg://user?id="..v..")\n"
...
local Info_Members = Redis:smembers(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(iqthon.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(iqthon.."iqthon:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(iqthon.."iqthon:Status:Id"..msg_chat_id,true) 
...
Redis:set(iqthon.."iqthon:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(iqthon.."iqthon:Status:Reply"..msg_chat_id,true) 
...
Redis:set(iqthon.."iqthon:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(iqthon.."iqthon:Status:JabwaId"..msg_chat_id,true) 
...
Redis:set(iqthon.."iqthon:BotFree",true) 
...
Redis:set(iqthon.."iqthon:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(iqthon.."iqthon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(iqthon.."iqthon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(iqthon.."iqthon1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(iqthon.."iqthon1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(iqthon.."iqthon1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(iqthon..'iqthon1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(iqthon..'iqthon1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(iqthon..'iqthon1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(iqthon.."iqthon1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(iqthon.."iqthon1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(iqthon.."iqthon1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(iqthon.."iqthon1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(iqthon.."iqthon1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(iqthon.."iqthon1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(iqthon.."iqthon1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(iqthon.."iqthon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(iqthon.."iqthon1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(iqthon.."iqthon1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(iqthon.."iqthon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(iqthon.."iqthon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(iqthon.."iqthon1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(iqthon.."iqthon1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(iqthon.."iqthon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(iqthon.."iqthon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(iqthon.."iqthon1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(iqthon.."iqthon1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(iqthon.."iqthon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(iqthon.."iqthon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(iqthon.."iqthon1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(iqthon.."iqthon1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(iqthon.."iqthon1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(iqthon.."iqthon1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(iqthon.."iqthon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(iqthon.."iqthon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(iqthon.."iqthon11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(iqthon.."iqthon11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(iqthon.."iqthon11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(iqthon..'iqthon11:Add:Rd:Sudo:Text'..text)
Redis:del(iqthon..'iqthon11:Add:Rd:Sudo:Text1'..text)
Redis:del(iqthon..'iqthon11:Add:Rd:Sudo:Text2'..text)
Redis:del(iqthon.."iqthon11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(iqthon.."iqthon11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(iqthon.."iqthon11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(iqthon.."iqthon11:Add:Rd:Sudo:Text"..v) 
Redis:del(iqthon.."iqthon11:Add:Rd:Sudo:Text1"..v) 
Redis:del(iqthon.."iqthon11:Add:Rd:Sudo:Text2"..v)   
Redis:del(iqthon.."iqthon11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(iqthon.."iqthon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(iqthon.."iqthon11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(iqthon.."iqthon11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(iqthon.."iqthon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(iqthon.."iqthon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(iqthon.."iqthon11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(iqthon.."iqthon11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(iqthon.."iqthon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(iqthon.."iqthon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(iqthon.."iqthon11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(iqthon.."iqthon11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(iqthon.."iqthon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(iqthon.."iqthon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(iqthon.."iqthon11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(iqthon.."iqthon11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(iqthon.."iqthon11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(iqthon.."iqthon11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(iqthon.."iqthon:allM"..msg.chat_id, msg.id)
if Redis:get(iqthon.."iqthon:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(iqthon.."iqthon:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(iqthon.."iqthon:allM"..msg.chat_id)
...
Redis:del(iqthon.."iqthon:allM"..msg.chat_id)
end
end
end
...
Redis:set(iqthon.."iqthon:Set:Id:Group"..msg.chat_id,Text_Rand)
...
local list = Redis:smembers(iqthon.."iqthon:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(iqthon.."iqthon:allM"..msg.chat_id)  
...
Redis:set(iqthon.."allM:numdel"..msg.chat_id,Numbardel) 
...
local gmria = Redis:scard(iqthon.."allM"..msg.chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,"↯  عدد الميديا الموجود هو (* "..gmria.." *)","md")
end
...
Redis:del(iqthon.."Status:Del:Media"..msg.chat_id)
...
Redis:set(iqthon.."Status:Del:Media"..msg.chat_id,true)
...
if TextMsg == 'الرابط' then
Redis:del(iqthon.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(iqthon.."iqthon:Status:Welcome"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Status:Id"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Status:Reply"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Status:JabwaId"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:BotFree") 
...
Redis:del(iqthon.."iqthon:TwaslBot") 
...
if Redis:sismember(iqthon.."iqthon:JabwaAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:JabwaAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:JabwaAll:Groups",UserId_Info.id) then
...
Redis:srem(iqthon.."iqthon:JabwaAll:Groups",UserId_Info.id) 
...
if Redis:sismember(iqthon.."iqthon:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(iqthon.."iqthon:ktmAll:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/uu_iqthon'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n♛ ︙  عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*♛ ︙  عذرآ البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
...
if not msg.Originators and not Redis:get(iqthon.."iqthon:Status:JabwaId"..msg_chat_id) then
...
if Redis:sismember(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'Jabwaned',0)
...
if not Redis:sismember(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم الغاء طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ♛ ︙  تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(iqthon.."iqthon:JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(iqthon.."iqthon:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(iqthon.."iqthon:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ♛ ︙  تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(iqthon.."iqthon:JabwaAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ♛ ︙  تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:JabwaAll:Groups",UserId) 
...
if Redis:sismember(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ♛ ︙  تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ♛ ︙  تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ♛ ︙  تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not msg.Originators and not Redis:get(iqthon.."iqthon:Status:JabwaId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"♛ ︙  تم تعطيل 〘الحظر : الطرد 〙 من قبل المدراء","md",true)
end 
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*᥀︙عذرآ البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
...
if Redis:sismember(iqthon.."Snap:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," تم طرده من المجموعه مسبقا ").Reply,"md",true, false, false, false, reply_markup)
else
Redis:sadd(iqthon.."Snap:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(iqthon.."Snap:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," تم الغاء الطرد من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."Snap:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," تم الغاء طرده  من المجموعه  ").Reply,"md",true)  
end
end
...
if Redis:sismember(iqthon.."Snap:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(iqthon.."Snap:BanGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(iqthon.."Snap:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."Snap:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(iqthon.."Snap:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," تم طرد من المجموعه مسبقا ").Reply,"md",true, false, false, false, reply_markup)
else
Redis:sadd(iqthon.."Snap:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," تم طرد من المجموعه ").Reply,"md",true, false, false, false, reply_markup)
end
end
...
if not Redis:sismember(iqthon.."Snap:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم الغاء طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."Snap:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/GO_XXO'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n♛ ︙  عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*♛ ︙  عذرا البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
...
if Redis:sismember(iqthon.."Snap:Status:BanId"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"♛ ︙  تم طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."Snap:Status:BanId"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'Jabwaned',0)
...
if not Redis:sismember(iqthon.."Snap:Status:BanId"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"♛ ︙  تم الغاء طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."Snap:Status:BanId"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if text == "نزلني" then
if not Redis:get(iqthon.."iqthon:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(iqthon.."iqthon:HELPBEVQ:Groups",msg.sender.user_id)  then
Rink = 1
elseif Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(iqthon.."iqthon:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(iqthon.."iqthon:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(iqthon.."iqthon:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(iqthon.."iqthon:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(iqthon.."iqthon:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(iqthon.."iqthon:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not Redis:get(iqthon.."iqthon:Status:KickMe"..msg_chat_id) then
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @iqthon"..Creator.."\n"
else
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(iqthon.."iqthon:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(iqthon.."iqthon:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(iqthon.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*♛ ︙  هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
Redis:set(iqthon.."addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(iqthon.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = Redis:get(iqthon..'ch:admin')},},{{text = 'سـورس تليثون ', url = 't.me/iqthon'},},}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n♛ ︙  عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(iqthon.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(iqthon.."iqthon:Lock:text"..msg_chat_id,true) 
...
Redis:set(iqthon.."iqthon:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(iqthon.."iqthon:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(iqthon.."iqthon:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(iqthon.."iqthon:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(iqthon.."lockalllll"..msg_chat_id,"off")
...
Redis:set(iqthon.."lockalllll"..msg_chat_id,"on")
...
Redis:set(iqthon.."iqthon:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(iqthon.."iqthon:Lock:edit"..msg_chat_id,true) 
...
Redis:set(iqthon.."iqthon:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(iqthon..'iqthon:'..lock..msg_chat_id,"del")    
end
...
if text == "حذف رد انلاين" then
    ...
    if ChannelJoin(msg) == false then
    local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/iqthon'}, },}}
    return LuaTele.sendText(msg.chat_id,msg.id,'*\n♛ ︙  - عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
    end
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    ...
    Redis:set(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true2")
  ...
  if text and text:match("^(.*)$") then
  if Redis:get(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
    Redis:del(iqthon.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
    Redis:del(iqthon.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
    Redis:del(iqthon.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
    Redis:del(iqthon.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
    Redis:del(iqthon.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
    Redis:del(iqthon.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
    Redis:del(iqthon.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
    Redis:del(iqthon.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
    Redis:del(iqthon.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
    Redis:del(iqthon.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
    Redis:del(iqthon.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
    Redis:del(iqthon.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
    Redis:del(iqthon.."Rd:Manager:inline:text"..text..msg_chat_id)
    Redis:del(iqthon.."Rd:Manager:inline:link"..text..msg_chat_id)
  Redis:del(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."")
  Redis:srem(iqthon.."List:Manager:inline"..msg_chat_id.."", text)
  ...
  if text == ("مسح الردود الانلاين") then
    ...
    local list = Redis:smembers(iqthon.."List:Manager:inline"..msg_chat_id.."")
    for k,v in pairs(list) do
        Redis:del(iqthon.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id)   
        Redis:del(iqthon.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id)   
        Redis:del(iqthon.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id)     
        Redis:del(iqthon.."Add:Rd:Manager:Text:inline"..v..msg_chat_id)   
        Redis:del(iqthon.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
        Redis:del(iqthon.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
        Redis:del(iqthon.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
        Redis:del(iqthon.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)  
        Redis:del(iqthon.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
        Redis:del(iqthon.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
        Redis:del(iqthon.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
        Redis:del(iqthon.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
        Redis:del(iqthon.."Rd:Manager:inline:v"..v..msg_chat_id)
        Redis:del(iqthon.."Rd:Manager:inline:link"..v..msg_chat_id)
    Redis:del(iqthon.."List:Manager:inline"..msg_chat_id)
    end
  ...
  if text == "اضف رد انلاين" then
    ...
    Redis:set(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,true)
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
  ...
  if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(TheMEZO) then
    if Redis:get(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true" then
    Redis:set(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true1")
    Redis:set(iqthon.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id, text)
    Redis:del(iqthon.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
    Redis:del(iqthon.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
    Redis:del(iqthon.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
    Redis:del(iqthon.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
    ...
    Redis:del(iqthon.."Rd:Manager:inline:text"..text..msg_chat_id)
    Redis:del(iqthon.."Rd:Manager:inline:link"..text..msg_chat_id)
    Redis:sadd(iqthon.."List:Manager:inline"..msg_chat_id.."", text)
    LuaTele.sendText(msg_chat_id,msg_id,[[
   ♛ ︙ ♛ ︙ ارسل لي الرد سواء كان 
    ❨ ملف ، ملصق ، متحركه ، صوره
     ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
  ...
  if Redis:get(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(TheMEZO) then
  Redis:del(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
  Redis:set(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
  if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
  local anubis = Redis:get(iqthon.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
  if msg.content.text then   
  text = text:gsub('"',"") 
  text = text:gsub('"',"") 
  text = text:gsub("`","") 
  text = text:gsub("*","") 
  Redis:set(iqthon.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
  elseif msg.content.sticker then   
  Redis:set(iqthon.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)  
  elseif msg.content.voice_note then  
  Redis:set(iqthon.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)  
  elseif msg.content.audio then
  Redis:set(iqthon.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)  
  Redis:set(iqthon.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
  elseif msg.content.document then
  Redis:set(iqthon.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)  
  elseif msg.content.animation then
  Redis:set(iqthon.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)  
  elseif msg.content.video_note then
  Redis:set(iqthon.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)  
  elseif msg.content.video then
  Redis:set(iqthon.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)  
  Redis:set(iqthon.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
  elseif msg.content.photo then
  if msg.content.photo.sizes[1].photo.remote.id then
  idPhoto = msg.content.photo.sizes[1].photo.remote.id
  elseif msg.content.photo.sizes[2].photo.remote.id then
  ...
  Redis:set(iqthon.."Add:Rd:Manager:Photo:inline"..anubis..msg_chat_id, idPhoto)  
  Redis:set(iqthon.."Add:Rd:Manager:Photoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
  end
  LuaTele.sendText(msg_chat_id,msg_id,"♛ ︙  - الان ارسل الكلام داخل الزر","md",true)  
  return false  
  end  
  end
  if text and Redis:get(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
  Redis:set(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id, "set_link")
  local anubis = Redis:get(iqthon.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
  Redis:set(iqthon.."Rd:Manager:inline:text"..anubis..msg_chat_id, text)
  LuaTele.sendText(msg_chat_id,msg_id,"♛ ︙  - الان ارسل الرابط","md",true)  
  return false  
  end
  if text and Redis:get(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
  Redis:del(iqthon.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
  local anubis = Redis:get(iqthon.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
  Redis:set(iqthon.."Rd:Manager:inline:link"..anubis..msg_chat_id, text)
  LuaTele.sendText(msg_chat_id,msg_id,"♛ ︙  - تم اضافه الرد بنجاح","md",true)  
  return false  
  end
  if text and not Redis:get(iqthon.."Status:Reply:inline"..msg_chat_id) then
  local btext = Redis:get(iqthon.."Rd:Manager:inline:text"..text..msg_chat_id)
  local blink = Redis:get(iqthon.."Rd:Manager:inline:link"..text..msg_chat_id)
  local anemi = Redis:get(iqthon.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  local veico = Redis:get(iqthon.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  local stekr = Redis:get(iqthon.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  local Texingt = Redis:get(iqthon.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  local photo = Redis:get(iqthon.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
  local photoc = Redis:get(iqthon.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
  local video = Redis:get(iqthon.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
  local videoc = Redis:get(iqthon.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
  local document = Redis:get(iqthon.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
  local audio = Redis:get(iqthon.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
  local audioc = Redis:get(iqthon.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
  local video_note = Redis:get(iqthon.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
  local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
  ...
  if Texingt then 
  local UserInfo = LuaTele.getUser(msg.sender.user_id)
  local NumMsg = Redis:get(iqthon..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
  local TotalMsg = Total_message(NumMsg) 
  local Status_Gps = msg.Name_Controller
  local NumMessageEdit = Redis:get(iqthon..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
  local Texingt = Texingt:gsub('#username',(UserInfo.username or 'لا يوجد')) 
  local Texingt = Texingt:gsub('#name',UserInfo.first_name)
  local Texingt = Texingt:gsub('#id',msg.sender.user_id)
  local Texingt = Texingt:gsub('#edit',NumMessageEdit)
  ...
  if text == ("الردود الانلاين") then
    ...
    for k,v in pairs(list) do
    if Redis:get(iqthon.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) then
    db = "متحركه♛ ︙ "
    elseif Redis:get(iqthon.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
    db = "بصمه♛ ︙ "
    elseif Redis:get(iqthon.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
    db = "ملصق♛ ︙ "
    elseif Redis:get(iqthon.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
    db = "رساله♛ ︙ "
    elseif Redis:get(iqthon.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
    db = "صوره♛ ︙ "
    elseif Redis:get(iqthon.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
    db = "فيديو♛ ︙ "
    elseif Redis:get(iqthon.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
    db = "ملف♛ ︙ "
    elseif Redis:get(iqthon.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
    db = "اغنيه♛ ︙ "
    elseif Redis:get(iqthon.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id) then
    db = "بصمه فيديو♛ ︙ "
    end
    text = text..""..k.." » {"..v.."} » {"..db.."}\n"
    end
...
Redis:del(iqthon.."iqthon:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(iqthon.."Lock:channell"..msg_chat_id)  
...
Redis:hset(iqthon.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(iqthon.."iqthon:Lock:text"..msg_chat_id)  
...
Redis:del(iqthon.."iqthon:Lock:Join"..msg_chat_id)  
...
Redis:del(iqthon.."iqthon:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(iqthon.."iqthon:Lock:tagservr"..msg_chat_id)  
...
Redis:del(iqthon.."iqthon:lockpin"..msg_chat_id)  
...
Redis:del(iqthon.."iqthon:Lock:edit"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(iqthon..'iqthon:'..lock..msg_chat_id)    
end
...
Redis:hset(iqthon.."iqthon:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(iqthon.."iqthon:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(iqthon.."iqthon:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(iqthon.."iqthon:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(iqthon.."iqthon:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(iqthon.."iqthon:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Link"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:User:Name"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:hashtak"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Cmd"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Photo"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Video"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Animation"..msg_chat_id)  
...
Redis:del(iqthon.."iqthon:Lock:geam"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Audio"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:vico"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Sticker"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:forward"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(iqthon..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(iqthon..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"♛ ︙  تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(iqthon..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(iqthon..'lock:Fshar'..msg.chat_id) 
...
Redis:del(iqthon..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"♛ ︙  تم فتح السب").unLock,"md",true)  
end
...
Redis:del(iqthon..'lock:Fars'..msg.chat_id) 
...
Redis:set(iqthon.."iqthon:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Document"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Contact"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Spam"..msg_chat_id)  
...
Redis:set(iqthon.."iqthon:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(iqthon.."iqthon:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(iqthon.."iqthon:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(iqthon.."iqthon:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(iqthon.."iqthon:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(iqthon.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(iqthon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(iqthon.."iqthon:Status:Welcome"..msg_chat_id) then
...
Redis:del(iqthon.."iqthon:Welcome:Group"..msg_chat_id) 
...
Redis:setex(iqthon.."iqthon:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(iqthon.."iqthon:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(iqthon.."iqthon:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(iqthon.."iqthon:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(iqthon.."iqthon:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(iqthon.."iqthon:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(iqthon.."iqthon:Filter:Group:"..v..msg_chat_id)  
Redis:srem(iqthon.."iqthon:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(iqthon.."iqthon:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(iqthon..'iqthon:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(iqthon..'iqthon:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*♛ ︙  ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(iqthon.."iqthon:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(iqthon.."iqthon:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(iqthon.."iqthon:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(iqthon.."iqthon:All:Get:Reides:Commands:Group"..v)
Redis:del(iqthon.."iqthon:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(iqthon.."iqthon:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(iqthon.."iqthon:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(iqthon.."iqthon:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(iqthon.."iqthon:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(iqthon.."iqthon:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ 〘 "..Commands.." 〙\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(iqthon.."Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:JabwaId"..msg.chat_id)  then
StatusJabwaId = '【 ✅ 】' else StatusJabwaId = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(iqthon.."iqthon:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = 'سـورس تليثون ', url = 't.me/iqthon'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id, TextChat,"md",true)
end
...
{
{text = 'رسال الرسائل : '..messges, data =msg.sender.user_id..  '/messges'}, 
},
{
...
Rink = 1
elseif Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(iqthon.."iqthon:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(iqthon.."iqthon:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*♛ ︙  تم تنزيل الشخص من الرتب التاليه { "..devs..""..dev..""..crr..""..cr..""..own..""..mod..""..vip.." *}","md",true)  
end
...
Rink = 1
elseif Redis:sismember(iqthon.."iqthon:DevelopersQ:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(iqthon.."iqthon:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(iqthon.."iqthon:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(iqthon.."iqthon:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(iqthon.."iqthon:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(iqthon.."iqthon:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
LuaTele.sendText(msg.chat_id, msg.id, t)
end
end
...
Redis:del(iqthon..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*♛ ︙  تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(iqthon..'iqthon:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*♛ ︙  تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(iqthon..'iqthon:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*♛ ︙  تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*♛ ︙  عدد رسائلك هنا ⇦ '..(Redis:get(iqthon..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*♛ ︙  عدد التعديلات هنا ⇦ '..(Redis:get(iqthon..'iqthon:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*♛ ︙  عدد جهاتك  ⇦ '..(Redis:get(iqthon.."iqthon:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(iqthon.."iqthon:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ♛ ︙  ارسل الان النص
 ♛ ︙  يمكنك اضافه :
...
Redis:del(iqthon.."iqthon:Set:Id:Groups")
return LuaTele.sendText(msg_chat_id,msg_id, ' ♛ ︙  تم ازالة كليشة الايدي العامه',"md",true)  
end
if Redis:get(iqthon.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
Redis:setex(iqthon.."iqthon:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ♛ ︙  ارسل الان النص
 ♛ ︙  يمكنك اضافه :
 ♛ ︙  `#username` ‹- اسم المستخدم
...
Redis:del(iqthon.."iqthon:Set:Id:Group"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id, ' ♛ ︙  تم ازالة كليشة الايدي ',"md",true)  
end
if text and text:match("^مسح (.*)$") and msg.reply_to_message_id == 0 then
local TextMsg = text:match("^مسح (.*)$")
if TextMsg == 'المطورين الثانويين' or TextMsg == 'المطورين الثانويين' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*♛ ︙  هاذا الامر يخص 〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
Redis:del(iqthon.."iqthon:DevelopersQ:Groups") 
...
Redis:del(iqthon.."iqthon:Developers:Groups") 
...
Redis:del(iqthon.."iqthon:TheBasics:Group"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Originators:Group"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Managers:Group"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Addictive:Group"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:Distinguished:Group"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:JabwaAll:Groups") 
...
Redis:del(iqthon.."iqthon:ktmAll:Groups") 
...
Redis:del(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(iqthon.."iqthon:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(iqthon.."iqthon:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(iqthon.."iqthon:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(iqthon.."iqthon:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(iqthon.."iqthon:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(iqthon.."iqthon:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(iqthon.."iqthon:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(iqthon.."iqthon:List:Manager"..msg_chat_id)
end
...
text = " ♛ ︙  قائمه الردود ⇧⇩\n\n"
for k,v in pairs(list) do
if Redis:get(iqthon.."iqthon:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ♛ ︙  "
elseif Redis:get(iqthon.."iqthon:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(iqthon.."iqthon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(iqthon.."iqthon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(iqthon.."iqthon:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(iqthon.."iqthon:Add:Rd:Sudo:Gif"..v)   
Redis:del(iqthon.."iqthon:Add:Rd:Sudo:vico"..v)   
Redis:del(iqthon.."iqthon:Add:Rd:Sudo:stekr"..v)     
Redis:del(iqthon.."iqthon:Add:Rd:Sudo:Text"..v)   
Redis:del(iqthon.."iqthon:Add:Rd:Sudo:Photo"..v)
Redis:del(iqthon.."iqthon:Add:Rd:Sudo:Video"..v)
Redis:del(iqthon.."iqthon:Add:Rd:Sudo:File"..v)
Redis:del(iqthon.."iqthon:Add:Rd:Sudo:Audio"..v)
Redis:del(iqthon.."iqthon:Add:Rd:Sudo:video_note"..v)
Redis:del(iqthon.."iqthon:List:Rd:Sudo")
end
...
text = "\n♛ ︙  قائمة الردود العامه ⇧⇩\n\n"
for k,v in pairs(list) do
if Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Sudo:File"..v) then
db = "ملف ♛ ︙  "
elseif Redis:get(iqthon.."iqthon:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(iqthon.."iqthon:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(iqthon.."iqthon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(iqthon.."iqthon:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(iqthon.."SendBcBot") then
...
Redis:setex(iqthon.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(iqthon.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(iqthon.."iqthon:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:setex(iqthon.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(iqthon.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local Added_Me = Redis:get(iqthon.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
UserInfo = LuaTele.getUser(Added_Me)
local Name = '['..UserInfo.first_name..'](tg://user?id='..Added_Me..')'
Text = ' خط الشخص الذي قام باضافتك هو -› '..Name
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
else
return LuaTele.sendText(msg_chat_id,msg_id,"*♛ ︙  انت دخلت عبر الرابط محد ضافك*","md",true) 
end
end
if Redis:get(iqthon.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
...
Redis:del(iqthon.."youtube"..msg.sender.user_id..msg_chat_id)
end
if Redis:get(iqthon.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = rep +1
https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg_chat_id.."&animation=https://t.me/youtube7odabot/7951&reply_to_message_id="..rep)
...
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).JabwaGroup == true then
JabwaGroup = 'محظور ,'
Redis:srem(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
JabwaGroup = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).SilentGroup == true then
...
Redis:set(iqthon..'iqthon:GetTexting:Deviqthon'..msg_chat_id..':'..msg.sender.user_id,true)
...
local TestText = "  ❲ Developers iqthon  ❳\n— — — — — — — — —\n *Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n♛ ︙  *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
if text == "صورتي" then
if Redis:get(iqthon.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
slwat = https.request("https://mahmoudm50.xyz/anubis/pray.php?city=Baghdad")
...
local m = "https://t.me/mazajeat_10/"..Rrr..""
local t = "اليك  فيديو🏴‍☠️♥️"
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendaudio?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&audio="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
photo = "https://t.me/IQTHON"
local T =[[  ]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مــطـور تليثون', url = "https://t.me/lll5l"},
},
{
{text = 'سـورس تليثون', url = "https://t.me/iqthon"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'كلاينر' or text == 'مبرمج' or text == 'مطور السورس' then
photo = "https://t.me/LLL5L"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ • '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '♛ ︙  مبرمج السورس', url = "https://t.me/lll5l"}
},
}
local msgg = msg_id/2097152/0.5
...
{
{text = '‹ اوامر االالعاب›', data = msg.sender.user_id..'/helma1'},
},
{
{text = 'سـورس تليثون ', url = 't.me/iqthon'}, 
},
...
return LuaTele.sendText(msg_chat_id,msg_id,[[*——————————
♛ ︙ الالعاب الخاصه سورس تليثون : 
♛ ︙ لتفعيل الالعاب او تعطيلها ارسل ⇊
( تعطيل الالعاب - تفعيل الالعاب )
——————————
1 - لعبة الاحرف ↵ ( حروف )
2 - لعبة اختار بينا ↵ ( لو خيروك )
3 - لعبة العكس ↵ ( العكس )
4 - لعبة الحزوره ↵ ( حزوره )
5 -  لعبة المعاني ↵ ( معاني )
6 - لعبة البات ↵ ( بات )
7 - لعبة التخمين ↵ ( خمن )
8 - لعبه الاسرع ↵ ( الاسرع )
9 - لعبة السمايلات ↵ ( سمايلات )
10 - لعبة الاعلام والدول ↵ ( اعلام )
11 -  لعبة الاختلاف ↵ ( المختلف)
12 -  لعبة رياضيات ↵ ( الرياضيات)
13 -  لعبة الأمثله  ↵ ( امثله )
14 -  لعبة الأمثله  ↵ ( الانكليزي )
——————————
...
elseif text == 'الالعاب الالكترونيه' or text == 'العاب الكترونيه' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if Redis:get(iqthon.."Status:kool"..msg.chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,"*هذا تعبان يريد يتجوز نفسه 😂*","md",true)  
end
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يحيوان 😒*","md",true)  
end
if Redis:sismember(iqthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(iqthon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(iqthon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(iqthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(iqthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(iqthon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if Redis:sismember(iqthon..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
...
Redis:sadd(iqthon..msg_chat_id.."lonely:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(iqthon..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
Redis:srem(iqthon..msg_chat_id.."lonely:",Message_Reply.sender.user_id)
Redis:sadd(iqthon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(iqthon..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
...
Redis:sadd(iqthon..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(iqthon..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
Redis:srem(iqthon..msg_chat_id.."klbklb:",Message_Reply.sender.user_id)
Redis:sadd(iqthon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if text == "رفع مطلقه" or text == "مطلقه" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
end
if Redis:sismember(iqthon..msg_chat_id.."muthlka:",Message_Reply.sender.user_id) then
local rd_tlaq = {"تم رفعه مطلقه مسبقا 😂",}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_tlaq[math.random(#rd_tlaq)]).Reply,"md",true) 
else
local rd_zwag = {"تم رفعه مطلقه في المجموعه 😂",}
if Redis:sismember(iqthon..msg_chat_id.."muthlka:",Message_Reply.sender.user_id) then 
Redis:srem(iqthon..msg_chat_id.."muthlka:",Message_Reply.sender.user_id)
end
Redis:sadd(iqthon..msg_chat_id.."muthlka:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true) 
end
end
if text == "تنزيل مطلقه" or text == "تنزل مطلقه" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
...
Redis:srem(iqthon..msg_chat_id.."muthlka:",Message_Reply.sender.user_id)
Redis:sadd(iqthon..msg_chat_id.."muthlka:",Message_Reply.sender.user_id) 
local rd_tlaq = [[😂 تم تنزيله مطلقه]]
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_tlaq)]).Reply,"md",true)  
else
local rd_tmtlaq = [[😂 تم تنزيله مطلقه مسبقا]]
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_tmtlaq)]).Reply,"md",true)   
end
end
if text == "رفع زوجتي" or text == "زوجتي" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
...
if Redis:sismember(iqthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {"تم رفعه زوجتي مسبقا 😂",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
else
local rd_zwag = {"تم رفعه زوجتي في المجموعه 😂",
}
if Redis:sismember(iqthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then 
Redis:srem(iqthon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
...
if text == "تنزيل زوجتي" or text == "تنزل زوجتي" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
...
Redis:srem(iqthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(iqthon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
local rd_tlaq = {"😂 تم تنزيله زوجتي",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_tmtlaq[math.random(#rd_tlaq)]).Reply,"md",true)  
else
local rd_tmtlaq = {"😂 تم تنزيله زوجتي مسبقا",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_tlaq[math.random(#rd_tmtlaq)]).Reply,"md",true)  
end
end
...
local zwgat_list = Redis:smembers(iqthon..msg_chat_id.."zwgat:")
...
local lonely_list = Redis:smembers(iqthon..msg_chat_id.."lonely:")
...
local mutlqat_list = Redis:smembers(iqthon..msg_chat_id.."muthlka:")
...
local klbklb_list = Redis:smembers(iqthon..msg_chat_id.."klbklb:")
...
if text == "رفع كيكه" or text == "كيكه" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
end
if Redis:sismember(iqthon..msg_chat_id.."kakhh:",Message_Reply.sender.user_id) then
local rd_mtzwga = {"تم رفع كيكة 🍰 مسبقا ",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
else
local rd_zwag = {"تم رفع كيكة 🍰",
}
if Redis:sismember(iqthon..msg_chat_id.."kakhh:",Message_Reply.sender.user_id) then 
Redis:srem(iqthon..msg_chat_id.."kakhh:",Message_Reply.sender.user_id)
end
Redis:sadd(iqthon..msg_chat_id.."kakhh:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
if text == "تنزيل كيكه" or text == "تنزل كيكه" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
...
if text == "تاك للكيكات" or text == "الكيكات" then
local zwgat_list = Redis:smembers(iqthon..msg_chat_id.."kakhh:")
if #zwgat_list == 0 then 
return LuaTele.sendText(msg_chat_id,msg_id,'*↯ ︙ لايوجد كيكات*',"md",true) 
end 
local zwga_list = "*🍰 ︙ قائمة الكيكات *"..#zwgat_list.."\n**\n"
for k, v in pairs(zwgat_list) do
local UserInfo = LuaTele.getUser(v)
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
zwga_list = zwga_list.."*"..k.." - *[@"..UserInfo.username.."](tg://user?id="..v..")\n"
...
if text == "رفع عسل" or text == "عسل" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
end
if Redis:sismember(iqthon..msg_chat_id.."ausll:",Message_Reply.sender.user_id) then
local rd_mtzwga = {"تم رفع عسل 🍯 مسبقا",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
else
local rd_zwag = {"تم رفع عسل 🍯",
}
if Redis:sismember(iqthon..msg_chat_id.."ausll:",Message_Reply.sender.user_id) then 
Redis:srem(iqthon..msg_chat_id.."ausll:",Message_Reply.sender.user_id)
end
Redis:sadd(iqthon..msg_chat_id.."ausll:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
if text == "تنزيل عسل" or text == "تنزل عسل" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
...
Redis:srem(iqthon..msg_chat_id.."ausll:",Message_Reply.sender.user_id)
Redis:sadd(iqthon..msg_chat_id.."ausll:",Message_Reply.sender.user_id) 
local rd_tlaq = {"تنزيل عسل 🍯",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_tlaq[math.random(#rd_tlaq)]).Reply,"md",true)  
else
local rd_tmtlaq = {"تنزيل عسل 🍯",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_tmtlaq[math.random(#rd_tmtlaq)]).Reply,"md",true)  
end
end

if text == "تاك للعسل" or text == "العسل" then
local zwgat_list = Redis:smembers(iqthon..msg_chat_id.."ausll:")
if #zwgat_list == 0 then 
return LuaTele.sendText(msg_chat_id,msg_id,'*↯ ︙ لايوجد عسل*',"md",true) 
end 
local zwga_list = "*🍯 ︙ قائمة العسل *"..#zwgat_list.."\n**\n"
for k, v in pairs(zwgat_list) do
local UserInfo = LuaTele.getUser(v)
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
zwga_list = zwga_list.."*"..k.." - *[@"..UserInfo.username.."](tg://user?id="..v..")\n"
...
if text == "رفع خرا" or text == "خرا" or text == "رفع خره" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
end
if Redis:sismember(iqthon..msg_chat_id.."kharah:",Message_Reply.sender.user_id) then
local rd_mtzwga = {"تم رفع خره 💩 مسبقا",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
else
local rd_zwag = {"تم رفع خره 💩",
}
if Redis:sismember(iqthon..msg_chat_id.."kharah:",Message_Reply.sender.user_id) then 
Redis:srem(iqthon..msg_chat_id.."kharah:",Message_Reply.sender.user_id)
end
Redis:sadd(iqthon..msg_chat_id.."kharah:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
if text == "تنزيل خرا" or text == "تنزل خرا" or text == "تنزيل خره" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
...
Redis:srem(iqthon..msg_chat_id.."kharah:",Message_Reply.sender.user_id)
Redis:sadd(iqthon..msg_chat_id.."kharah:",Message_Reply.sender.user_id) 
local rd_tlaq = {"تم تنزيل خره 💩",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_tlaq[math.random(#rd_tlaq)]).Reply,"md",true)  
else
local rd_tmtlaq = {"تم تنزيل خره 💩",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_tmtlaq[math.random(#rd_tmtlaq)]).Reply,"md",true)  
end
end

if text == "تاك للخرا" or text == "الخرا" or text == "الخره" or text == "تاك للخره" then
local zwgat_list = Redis:smembers(iqthon..msg_chat_id.."kharah:")
if #zwgat_list == 0 then 
return LuaTele.sendText(msg_chat_id,msg_id,'*↯ ︙ لايوجد خرا*',"md",true) 
end 
local zwga_list = "*💩 ︙ قائمة الخرا *"..#zwgat_list.."\n**\n"
for k, v in pairs(zwgat_list) do
local UserInfo = LuaTele.getUser(v)
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
zwga_list = zwga_list.."*"..k.." - *[@"..UserInfo.username.."](tg://user?id="..v..")\n"
...
if text == "رفع بقره" or text == "بقره" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
end
if Redis:sismember(iqthon..msg_chat_id.."bakharh:",Message_Reply.sender.user_id) then
local rd_mtzwga = {"تم رفع بقره 🐄 مسبقا",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
else
local rd_zwag = {"تم رفع بقره 🐄",
}
if Redis:sismember(iqthon..msg_chat_id.."bakharh:",Message_Reply.sender.user_id) then 
Redis:srem(iqthon..msg_chat_id.."bakharh:",Message_Reply.sender.user_id)
end
Redis:sadd(iqthon..msg_chat_id.."bakharh:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
if text == "تنزيل بقره" or text == "تنزل بقره" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(iqthon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت ︙ *","md",true)  
...
Redis:srem(iqthon..msg_chat_id.."bakharh:",Message_Reply.sender.user_id)
Redis:sadd(iqthon..msg_chat_id.."bakharh:",Message_Reply.sender.user_id) 
local rd_tlaq = {"تم تنزيل بقره 🐄",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_tmtlaq[math.random(#rd_tmtlaq)]).Reply,"md",true)  
else
local rd_tmtlaq = {" تم تنزيل بقره 🐄",
}
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_tlaq[math.random(#rd_tlaq)]).Reply,"md",true)  
end
end

if text == "تاك للبقرات" or text == "البقرات" then
local zwgat_list = Redis:smembers(iqthon..msg_chat_id.."bakharh:")
if #zwgat_list == 0 then 
return LuaTele.sendText(msg_chat_id,msg_id,'*🐄 ︙ لايوجد بقرات*',"md",true) 
end 
local zwga_list = "*🐄 ︙ قائمة البقرات *"..#zwgat_list.."\n**\n"
for k, v in pairs(zwgat_list) do
local UserInfo = LuaTele.getUser(v)
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
zwga_list = zwga_list.."*"..k.." - *[@"..UserInfo.username.."](tg://user?id="..v..")\n"
...
data = {
{
{text = 'موافقه 👰', data = Message_Reply.sender.user_id..'/zog1'},{text = 'لست موافقه😩', data = Message_Reply.sender.user_id..'/zog2'}, 
},
}
}
...
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,'*مع الف سلامه  🌝💜*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*خدوني معاكم خاص والنبي 🥺💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'* نزل عينك جوه  😒❤️*',"md",false, false, false, false, reply_markup)
end
if text == '🙄' or text == '🙄🙄' then
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'*ضحكتك عسل مثلك ينوحيي 🌝❤️*',"md",false, false, false, false, reply_markup)
end
if text == '😹' or text == '😹' then
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'* تفكر بشنو 🤔*',"md",false, false, false, false, reply_markup)
end
if text == '🌚' or text == '🌝' then
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'*القمر  يشبهك 🙂❤️*',"md",false, false, false, false, reply_markup)
end
if text == '💋' or text == '💋💋' then
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'*انا اريد بوسه انا  🥺💔*',"md",false, false, false, false, reply_markup)
end
if text == '😭' or text == '😭😭' then
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'*لاتزعل بحبك 😻🤍*',"md",false, false, false, false, reply_markup)
end
if text == '😒' or text == '😒😒' then
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'*عدل وجهك ونت تحاجيني 😒🙄*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*وانا هم بعشقك يا روحي 🤗🥰*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*اشش انت 😹*',"md",false, false, false, false, reply_markup)
end
...
if text == 'الخاص' or text == 'شوف الخاص' then
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
return LuaTele.sendText(msg_chat_id,msg_id,'*خخخ اويلي 😹*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*اه شنو عيب 😹💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*عيب ياحيوان 🙄💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*لا ماجي 😹💔*',"md",false, false, false, false, reply_markup)
end
if text == 'هيح'  then
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'*هيج لو ديج😹💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*هذا نورك قلبي يقلبي*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*وين رايح وتاركني 💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*اهدا  😒*',"md",false, false, false, false, reply_markup)
end
...
if text == 'حموت' or text == 'اموت' then
if not Redis:get(iqthon.."iqthon:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
return LuaTele.sendText(msg_chat_id,msg_id,'* لف ورجع تانى  😂🚶‍♂👻*',"md",false, false, false, false, reply_markup)
end
...
Redis:setex(iqthon.."iqthon:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(iqthon.."iqthon:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  تم حذف اسم البوت ","md",true)   
end
if text == "بوت" then
local NameBot = (Redis:get(iqthon.."iqthon:Name:Bot") or "تليثون")
local BotName = {
...
if not msg.ControllerBot and not Redis:set(iqthon.."iqthon:LeftBot") then
...
data = {
{
{text = 'متاكد 🥺', data = '/Zxchq'..msg_chat_id}, {text = 'الغاء الامر', data = msg.sender.user_id..'/Redis'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*♛ ︙  فكر مره ثانيه 🥺*',"md",false, false, false, false, reply_markup)
end
...
x = x + 1
Redis:srem(iqthon..'iqthon:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,iqthon)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*♛ ︙  البوت عضو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(iqthon..'iqthon:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(iqthon..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(iqthon..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(iqthon..'iqthon:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(iqthon.."iqthon:Game:Smile"..msg.chat_id,SM)
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس تليثون؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس تليثون؟ ", 
"كم مره حبيت؟ ", 
...
Redis:set(iqthon.."iqthon:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(iqthon.."iqthon:Game:Alam"..msg.chat_id,name)
...
Redis:set(iqthon.."iqthon:Game:Riddles"..msg.chat_id,name)
...
if Redis:get(iqthon.."iqthon:Status:Games"..msg.chat_id) then
katu = {"9","46","2","9","5","4","25","10","17","15","39","5","16"}
name = katu[math.random(#katu)]
Redis:set(iqthon.."iqthon:Game:mathematics"..msg.chat_id,name)
...
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  اكمل المعادله التاليه ~ 〘 "..name.." 〙","md",true)  
end
end
...
katu = {"😸","☠","🐼","🐇","🌑","🌚","⭐️","✨","⛈","🌥","⛄️","👨‍🔬","👨‍💻","👨‍🔧","🧚‍♀","‍♂","🧝‍♂","🙍‍♂","🧖‍♂","👬","🕒","🕤","⌛️","📅"}
name = katu[math.random(#katu)]
Redis:set(iqthon.."iqthon:Game:Difference"..msg.chat_id,name)
...
Redis:set(iqthon.."iqthon:Game:Example"..msg.chat_id,name)
...
Redis:set(iqthon.."iqthon:Game:Meaningof"..msg.chat_id,name)
...
name = katu[math.random(#katu)]
Redis:set(iqthon.."iqthon:Game:Reflection"..msg.chat_id,name)
...
Redis:set(iqthon.."iqthon:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
if Redis:get(iqthon.."iqthon:Status:Games"..msg.chat_id) then
Redis:del(iqthon.."iqthon:Set:Aks"..msg.chat_id)
katu = {"ذئب","معلومات","قنوات","مجموعات","كتاب","تفاحه","نقود","اعلم","اعلم","تمساح","شاطئ","غبي","صداقه"}
name = katu[math.random(#katu)]
Redis:set(iqthon.."iqthon:Game:English"..msg.chat_id,name)
...
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  ما معنى كلمة ~ 〘 "..name.." 〙","md",true)  
end
end
if text == "اسئله" then
if Redis:get(iqthon.."iqthon:Status:Games"..msg.chat_id) then
Redis:del(iqthon.."iqthon:Set:Aks"..msg.chat_id)
katu = {'النيل','14','الفم','11','30','بوتين','ستيف جوبر','باريس','10','النمل','حرف الواو','الشعر','سحاب','الاسم','ذهب','حرف الام','العزائم','انسات','المنجنيق','اسيا','6','الاسد','مهر','الدولفين','اوروبا','الزئبق','لندن','الانسان','طوكيو','خديجه'}
name = katu[math.random(#katu)]
Redis:set(iqthon.."iqthon:Game:question"..msg.chat_id,name)
...
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  ارسل الجواب الصحيح فقط ~ 〘 "..name.." 〙","md",true)  
end
end
...
local NumberGame = Redis:get(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(iqthon.."iqthon:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(iqthon.."iqthon:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'مك','مسح المكتومين')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(iqthon.."iqthon:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
local photo = LuaTele.getUserProfilePhotos(iqthon)
local ban = LuaTele.getUser(iqthon)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(iqthon..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(iqthon.."Start:Bot") then
...
local CmdStart = '*\n♛ ︙  أهلآ بك في بوت '..(Redis:get(iqthon.."iqthon:Name:Bot") or "تليثون")..
...
keyboard.inline_keyboard = {
{
{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', url = 't.me/iqthon'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(iqthon.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
{
{text = '〘 الثانويين 〙',type = 'text'},{text = '〘 المطورين 〙',type = 'text'},{text = '〘 قائمه العام 〙', type = 'text'},
},
{
{text = '〘 مسح الثانويين 〙',type = 'text'},{text = '〘 مسح المطورين 〙',type = 'text'},{text = '〘 مسح قائمه العام 〙', type = 'text'},
},
{
...
Redis:setex(iqthon.."iqthon:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(iqthon.."iqthon:Start:Bot") 
...
Redis:setex(iqthon.."iqthon:Change:iqthon:Name:Bot"..msg.sender.user_id,300,true) 
return LuaTele.sendText(msg_chat_id,msg_id," ♛ ︙  ارسل لي الاسم الان ","md",true)  
end
if text == '〘 حذف اسم البوت 〙' then 
if not msg.ControllerBot then 
...
Redis:setex(iqthon.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
 ♛ ︙  ارسل اذاعتك لتثبيت في الجروبات
 ♛ ︙  للخروج من الامر ارسل〘الغاء〙
*]],"md",true)  
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '♛ ︙  مسح الثانويين ', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if not msg.ControllerBot then
if Redis:get(iqthon.."iqthon:TwaslBot") and not Redis:sismember(iqthon.."iqthon:Jabwa:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(iqthon.."iqthon:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(iqthon.."iqthon:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(iqthon..'iqthon:Jabwa:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' ↯♛ ︙  تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(iqthon..'iqthon:Jabwa:In:Tuasl',Info_User)  
...
DeleteMessage(data.chat_id,{[0] = Msg_id})  
...
DeleteMessage(data.chat_id,{[0] = Msg_id})    
https.request('klanrsulten.ml/Pascar.php?url='..Id_Link..'&token='..token..'&chat='..data.chat_id..'&type=mp3&msg=0')
elseif Text and Text:match('ogg/(.*)') then
local Id_Link = Text:match('ogg/(.*)') 
DeleteMessage(data.chat_id_,{[0] = Msg_id})    
https.request('klanrsulten.ml/Pascar.php?url='..Id_Link..'&token='..token..'&chat='..data.chat_id..'&type=ogg&msg=0')
elseif Text and Text:match('mp4/(.*)') then
local Id_Link = Text:match('mp4/(.*)') 
DeleteMessage(data.chat_id,{[0] = Msg_id})    
https.request('klanrsulten.ml/Pascar.php?url='..Id_Link..'&token='..token..'&chat='..data.chat_id..'&type=mp4&msg=0')
end

if data and data.luatele and data.luatele == "updateSupergroup" then
local Get_Chat = LuaTele.getChat('-100'..data.supergroup.id)
if data.supergroup.status.luatele == "chatMemberStatusJabwaned" then
Redis:srem(iqthon.."iqthon:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(iqthon..'*'..'-100'..data.supergroup.id..'*')
Redis:del(iqthon.."iqthon:List:Manager"..'-100'..data.supergroup.id)
Redis:del(iqthon.."iqthon:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(iqthon.."iqthon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(iqthon.."iqthon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(iqthon.."iqthon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(iqthon.."iqthon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(iqthon.."iqthon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(iqthon.."iqthon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(iqthon.."iqthon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(iqthon.."iqthon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(iqthon.."iqthon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(iqthon.."iqthon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(iqthon.."iqthon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(iqthon.."iqthon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(iqthon.."iqthon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(iqthon.."iqthon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(iqthon.."iqthon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(iqthon.."iqthon:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(iqthon.."iqthon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(iqthon.."iqthon:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(iqthon.."iqthon:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(iqthon) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(iqthon..'iqthon:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == iqthon then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(iqthon..'iqthon:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(iqthon.."iqthon:Lock:edit"..data.chat_id) then
...
Redis:del(iqthon.."iqthon:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(iqthon.."iqthon1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(iqthon.."iqthon:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(iqthon.."iqthon:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(iqthon.."iqthon1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(iqthon.."iqthon:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id," ♛ ︙   ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(iqthon.."iqthon:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id," ♛ ︙   ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..ChatId..IdUser, 1)  
...
data = {
{
{text = '‹ cristina source ›', url = 't.me/iqthon'}, 
},
}
}
local TextHelp = [[*
♛ ︙  ارسل ما تريد تحميله
*]]
Redis:set(iqthon.."youtube"..IdUser..ChatId,'mp3')
...
♛ ︙  ارسل ما تريد تحميله
*]]
Redis:set(iqthon.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
data = {
{
{text = 'اوامر المطور', data = IdUser..'/helpo1'}, {text = 'اوامر المطورالثانوي ', data = IdUser..'/helpo2'}, 
},
{
{text = 'اوامر المطور الاساسي ', data = IdUser..'/helpo3'},
},
...
{
{text = 'اوامر المطورالاساسي ', data = IdUser..'/helpo3'}, 
},
{
{text = 'القائمه الرئيسيه ', data = IdUser..'/helpall'},
},
...
{
{text = '‹ اوامر االالعاب›', data = IdUser..'/helpall1'},
},
{
{text = 'سـورس تليثون ', url = 't.me/iqthon'}, 
},
...
data = {
{
{text = 'مشئين الاساسيين ', data = IdUser..'/TheBasics'}, {text = ' مسح المالكين', data = IdUser..'/TheBasicsQ'}, 
},
{
...
local TextHelp = [[*
♛ ︙ الك قسم الالعاب من سورس تليثون
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(iqthon.."iqthon:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(iqthon.."iqthon:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(iqthon.."iqthon:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(iqthon.."iqthon:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'belalmadeson'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Status:JabwaId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'belalmadeson'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Status:JabwaId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(iqthon.."iqthon:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(iqthon.."iqthon:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(iqthon.."iqthon:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(iqthon.."iqthon:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(iqthon..'iqthon:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(iqthon.."iqthon:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:DevelopersQ:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"*♛ ︙  تم مسح مطورين الثانويين من البوت *", 'md', false)
end
elseif Text and Text:match('(%d+)/TheBasics') then
local UserId = Text:match('(%d+)/TheBasics')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:Redisa:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:JabwaGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"*♛ ︙  تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(iqthon.."iqthon:SilentGroup:Group"..ChatId) 
