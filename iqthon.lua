...
ControllerAll = false
local ListSudos ={Sudo_Id,428577454,1226408155}  
...
if UserId == 428577454 then
Status  = 'مبرمج السورس'
elseif UserId == 952989068 then
Status = 'مطور سورس'
elseif UserId == 1226408155 then
Status = 'مطور سورس'
elseif UserId == 1130299829 then
Status = 'مطور سورس'
elseif UserId == 2145675356 then
Status = 'مطوره سورس'
...
if tonumber(msg.sender.user_id) == 428577454 then
msg.Name_Controller = 'مبرمج السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 952989068 then
msg.Name_Controller = 'مطور السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1226408155 then
msg.Name_Controller = 'مطور السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1130299829 then
msg.Name_Controller = 'مطور السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2145675356 then
...
local N = (Redis:get(iqthon.."iqthon:Name:Bot") or "صعب")
...
if Redis:get(iqthon.."iqthon:Game:question"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:question"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:question"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ↯ ︙ لقد فزت في اللعبه \n ↯ ︙ اللعب مره اخره وارسل - اسئله","md",true)  
end
end 
if Redis:get(iqthon.."iqthon:Game:Example"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:Example"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:Example"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ↯ ︙ لقد فزت في اللعبه \n ↯ ︙ اللعب مره اخره وارسل - امثله","md",true)  
end
end
if Redis:get(iqthon.."iqthon:Game:aoismm"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:aoismm"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:aoismm"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ↯ ︙ لقد فزت في اللعبه \n ↯ ︙ اللعب مره اخره وارسل - العواصم","md",true)  
end
end 
if Redis:get(iqthon.."iqthon:Game:Difference"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:Difference"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:Difference"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ↯ ︙ لقد فزت في اللعبه \n ↯ ︙ اللعب مره اخره وارسل - المختلف","md",true)  
end
end 
if Redis:get(iqthon.."iqthon:Game:mathematics"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:mathematics"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:mathematics"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ↯ ︙ لقد فزت في اللعبه \n ↯ ︙ اللعب مره اخره وارسل - الرياضيات","md",true)  
end
end 
if Redis:get(iqthon.."iqthon:Game:English"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:English"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:English"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ↯ ︙ لقد فزت في اللعبه \n ↯ ︙ اللعب مره اخره وارسل - الانكليزي","md",true)  
end
end 
...
if Redis:get(iqthon.."iqthon:Game:arkkamm"..msg.chat_id) then
if text == Redis:get(iqthon.."iqthon:Game:arkkamm"..msg.chat_id) then
Redis:incrby(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(iqthon.."iqthon:Game:arkkamm"..msg.chat_id)
...
NameBot = (Redis:get(iqthon.."iqthon:Name:Bot") or "صعب")
...
{
{text = Jabwa, url = 't.me/MMUC2'}, 
},
{
{text = Grosupsw, url = 't.me/MMUC2'}, 
},
{
{text = Usperos, url = 't.me/MMUC2'}, 
},
}
...
local NumberGames = Redis:get(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(iqthon.."iqthon:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(iqthon.."iqthon:Set:Id:Group"..msg_chat_id)
...
local TotalEdit = Redis:get(iqthon..'iqthon:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(iqthon.."iqthon:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(iqthon.."iqthon:Num:Add:Games"..msg.chat_id..UserId) or 0
local Texting = {'ملاك وناسيك بكروبنه??',"حلغوم والله☹️ ","اطلق صوره🐼❤️","كيكك والله🥺","لازك بيها غيرها عاد😒",}
local Description = Texting[math.random(#Texting)]
if UserInfo.username then
UserInfousername = '@'..UserInfo.username..''
...
if not Redis:get(iqthon.."iqthon:Status:Bio"..msg_chat_id) then
return false
end
...
Redis:del(iqthon.."iqthon:Status:Del:Media"..msg.chat_id)
...
Redis:set(iqthon.."iqthon:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(iqthon.."iqthon:Status:Bio"..msg.chat_id)
 LuaTele.sendText(msg_chat_id,msg_id,' ↯︙ تم تعطيل البايو')
return false
end 
...
Redis:set(iqthon.."iqthon:Status:Bio"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,' ↯︙ تم تفعيل البايو')
return false
end 
...
Redis:del(iqthon.."Snap:Status:yt"..msg.chat_id)
...
Redis:set(iqthon.."Snap:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(iqthon.."Snap:Status:yt"..msg.chat_id) then
...
if Redis:sismember(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'Jabwaned',0)
...
if not Redis:sismember(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not msg.Originators and not Redis:get(iqthon.."iqthon:Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ︙ تم تعطيل (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
...
if Redis:sismember(iqthon.."iqthon:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(iqthon.."iqthon:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(iqthon.."iqthon:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(iqthon.."iqthon:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ︙ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'Jabwaned',0)
...
if not Redis:sismember(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ︙ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(iqthon.."iqthon:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @MMUC2"..Creator.."\n"
else
...
data = {
{
{text = 'سـورس صعـب ', url = 't.me/MMUC2'}, 
},
}
}
...
as = http.request('https://timoa.ml/API/mean.php?name='..URL.escape(TextName)..'')
mn = JSON.decode(as)
k = mn.meaning
...
local NumMsg = Redis:get(iqthon..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
LuaTele.sendText(msg_chat_id,msg_id,'*↯ ︙ عدد رسائلك هنا ⇦ '..NumMsg..'*',"md",true)  
...
local m = "https://t.me/bsmaatt/"..Rrr..""
...
photo = "https://t.me/sMsMM/22"
local T =[[  ]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مــطـور صـعـب', url = "https://t.me/AAA2F"},
},
{
{text = 'سـورس صعـب', url = "https://t.me/MMUC2"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'صعب' or text == 'مبرمج' or text == 'مطور السورس' then
photo = "https://t.me/AAA2F"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ • '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '↯ ︙ مبرمج السورس', url = "https://t.me/AAA2F"}
},
}
local msgg = msg_id/2097152/0.5
...
if text == "بوت" then
local NameBot = (Redis:get(iqthon.."iqthon:Name:Bot") or "صعب")
local BotName = {
...
if text == "امثله" then
mthal = {"جوز","ضراطه","الحبل","الحافي","شقره","بيدك","سلايه","النخله","الخيل","حداد","المبلل","يركص","العنب","العمه","الخبز","بالحصاد","شهر","شكه","يكحله",};
...
name = string.gsub(name,"اسمة ... ومنجله مكسور","بالحصاد")
...
name = mthal[math.random(#mthal)]
Redis:set(iqthon.."iqthon:Game:aoismm"..msg.chat_id,name)
...
Redis:set(iqthon.."iqthon:Game:arkkamm"..msg.chat_id,name)
...
Redis:incrby(iqthon.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(iqthon.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local CmdStart = '*\n↯ ︙ أهلآ بك في بوت '..(Redis:get(iqthon.."Name:Bot") or "صعب")..
...
keyboard.inline_keyboard = {
{
{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', url = 't.me/MMUC2'}, 
},
{
...
data = {
{
{text = '‹ cristina source ›', url = 't.me/MMUC2'}, 
},
}
}
local TextHelp = [[*
